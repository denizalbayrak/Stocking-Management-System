...
public class LoginPage {
	...
	public static void main(String[] args) {
		...
		Admin.getAdmin().employeeAdd("Ahmet Y�lmaz", 1653);
		Admin.getAdmin().employeeAdd("Eda Sar�", 2010);
		Admin.getAdmin().employeeAdd("Ay�e G�ler", 2030);
		Admin.getAdmin().employeeAdd("H�seyin Erdo�an", 1653);
		Admin.getAdmin().employeeAdd("Umut �avk", 1700);
