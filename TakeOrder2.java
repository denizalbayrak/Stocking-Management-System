...
public class TakeOrder2 {
	...
	public String[] reachFoods(Management mng) {
		...
		String[] temp = new String[Admin.getAdmin().getStock().getFood().size()];
		int i = 0;
		for (Product f : Admin.getAdmin().getStock().getFood().values()) {
	...
	public String[] reachDrinks(Management mng) {
		...
		String[] temp = new String[Admin.getAdmin().getStock().getDrink().size()];
		int i = 0;
		for (Product d : Admin.getAdmin().getStock().getDrink().values()) {
	...
	public TakeOrder2(final JFrame superF, final Management mng, String employeeName, final int tableNumber) {
		...
		cbxFoods.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblFoodPrice.setText("Unit Price: " + Admin.getAdmin().getStock().getFood()
		...
		cbxDrinks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblDrinkPrice.setText("Unit Price: " + Admin.getAdmin().getStock().getDrink()
		...
		btnPlusF.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblTotalFoodPrice.setText("Total Food Price: " + (Integer.parseInt(lblNumberF.getText()) * Admin.getAdmin()
			...
			public void actionPerformed(ActionEvent e) {
				if (!lblNumberF.getText().equals("0")) {
					...
					lblTotalFoodPrice.setText(
							"Total Food Price: " + (Integer.parseInt(lblNumberF.getText()) * Admin.getAdmin().getStock()
		...
		btnPlusD.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblTotalDrinkPrice.setText("Total Drink Price: " + (Integer.parseInt(lblNumberD.getText()) * Admin.getAdmin()
			...
			public void actionPerformed(ActionEvent e) {
				if (!lblNumberD.getText().equals("0")) {
					...
					lblTotalDrinkPrice.setText(
							"Total Drink Price: " + (Integer.parseInt(lblNumberD.getText()) * Admin.getAdmin().getStock()
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(input == JOptionPane.OK_OPTION)
				{
					mng.addOrder(tableNumber,
							Admin.getAdmin().getStock().getFood().get(cbxFoods.getSelectedItem().toString()),
							Integer.parseInt(lblNumberF.getText()));
					mng.addOrder(tableNumber,
							Admin.getAdmin().getStock().getDrink().get(cbxDrinks.getSelectedItem().toString()),
